...
#pragma warning restore
        ...
        public async void RunMonitoring(HashSet<string> processes)
        {
            ...
            var followedPrograms =
                await new RequestManager()
                    .GatherFollowedPrograms(Id); //ezzel lehet még akciózni, hogy ha adott prgoram fut akkor
        ...
        /// <returns></returns>
        public bool CheckIfProgramNotInUpdatedList(Dictionary<string, int> followedPrograms,
            Dictionary<int, Stopwatch> programsToUpdate, string processName)
        {
            int? id = null;
            ...
            foreach (var programtoUpdate in followedProgramsRunning)
        ...
        public List<string> CheckDifferences(List<string> serverPrograms, List<string> myPrograms)
        {
            ...
            var programsToAdd = new List<string>();
