...
namespace Series.Service
{
    public interface ISeries
    {
        ...
        //Task MarkEpisodeStarted(EpisodeStartedDto episodeStarted, string showName);
        ...
        //Task<bool> IsEpisodeStarted(EpisodeStartedDto episodeStarted);
        Task<bool> UpdateStartedEpisode(EpisodeStartedDto episodeStarted, string showName);
